...
from AM import BOTLOG_CHATID, catub
...
@catub.cat_cmd(
    ...
    info={
        "header": "To customize your CatAM.",
        "options": {
...
@catub.cat_cmd(
    ...
    info={
        "header": "To delete costomization of your CatAM.",
        "options": {
...
async def del_custom(event):
    "To delete costomization of your CatAM."
    input_str = event.pattern_match.group(1)
    if input_str == "pmpermit":
