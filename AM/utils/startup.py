...
from AM import BOTLOG, BOTLOG_CHATID, PM_LOGGER_GROUP_ID
    ...
    try:
        if BOTLOG:
            Config.CATUBLOGO = await catub.tgbot.send_file(
                BOTLOG_CHATID,
                "https://te.legra.ph/file/0b85e4ef71d6f9e463736.jpg",
                caption="**Your Userbot has been started successfully.**",
                buttons=[(Button.url("Support", "https://t.me/AM_YTSupport"),)],
            )
    except Exception as e:
        LOGS.error(e)
        return None
...
async def verifyLoggerGroup():
    ...
    if BOTLOG:
        ...
        _, groupid = await create_supergroup(
            "AMBOT Log Group", catub, Config.TG_BOT_USERNAME, descript
        )
