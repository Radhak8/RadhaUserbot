...
async def deploy_article(event):
    buttons = [
        (
            Button.url("AMBOT", "https://t.me/AmBotYT"),
            Button.url("Radha World", "https://t.me/RadhaX2Support"),
        )
    ]
    return await build_article(
        event,
        ...
        media="https://te.legra.ph/file/6f55ba16bcb599afdd54f.jpg",
...
async def article_builder(event, method):
    media = thumb = None
    title = "Userbot"
    description = "Button menu for Userbot"
    if method == "ialive":
        buttons = [
            (
                Button.inline("Stats", data="stats"),
                Button.url("AMBOT", "https://t.me/AM_YTBOTT"),
            )
        ]
        try:
            from AM.plugins.alive import catalive_text
        ...
        try:
            from AM.plugins.spotify import spotify_inline_article
        ...
        from AM.plugins.button import inline_button_aricle
