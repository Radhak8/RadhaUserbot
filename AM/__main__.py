...
import AM
from AM import BOTLOG_CHATID, PM_LOGGER_GROUP_ID
...
LOGS.info(AM.__copyright__)
LOGS.info(f"Licensed under the terms of the {AM.__license__}")
...
async def startup_process():
    ...
    LOGS.info("||   If you need assistance, head to https://t.me/AM_YTSupport")
    LOGS.info(
        "============================================================================"
    )
    await verifyLoggerGroup()
