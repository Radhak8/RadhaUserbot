...
class Config(object):
    ...
    SCREEN_SHOT_LAYER_ACCESS_KEY = os.environ.get("SCREEN_SHOT_LAYER_ACCESS_KEY", "f7yUCHCtiFmIToOPYaQL2x1CI80ldCXw")
    ...
    OCR_SPACE_API_KEY = os.environ.get("OCR_SPACE_API_KEY", "K81964788188957")
    # Genius lyrics get this value from https://genius.com/developers both has
    GENIUS_API_TOKEN = os.environ.get("GENIUS_API_TOKEN", "SrmNgcs_J3TL6pJJITF8ferYCWa9TDC9skiHoz5rXEYLEvuYC3fwsY4y7QhnQkx_")
    # Get your own API key from https://www.remove.bg/
    REM_BG_API_KEY = os.environ.get("REM_BG_API_KEY", "SA5FWAUa6jwGbxfUpm2H836T")
    ...
    OPENAI_API_KEY = os.environ.get("OPENAI_API_KEY", "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")
